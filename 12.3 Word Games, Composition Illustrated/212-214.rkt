...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 212-214) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (arrangements (list "e" "d")) (list (list "e" "d") (list "d" "e")))
...
(check-expect
 (insert-everywhere/in-word "d" (list '())) (list "d"))

(check-expect
 (insert-everywhere/in-word "d" (list "e" "r"))
 (list (list "d" "e" "r") (list "e" "d" "r") (list "e" "r" "d")))

(define (insert-everywhere/in-word 1s w)
  (cond
    [(empty? w) (list (list 1s))]
    [else (cons (cons 1s w) (add-at-first (first w) (insert-everywhere/in-word 1s (rest w))))]))
...
(define (add-at-first l w)
  (cond
    [(empty? w) '()]
    [else (cons (append (list l) (first w))
